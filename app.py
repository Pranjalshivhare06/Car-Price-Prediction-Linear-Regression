...
st.header('Car Price Prediction model using ML(Linear Regression)')
...
owner = st.selectbox('Seller Type', car_data['owner'].unique())
...
#     )
#     st.write(input_model_data)
#     input_model_data['owner']
